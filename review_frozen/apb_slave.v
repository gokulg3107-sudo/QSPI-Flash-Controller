...
module apb_slave(qspi_busy, start_toggle, rx_fifo_data, psel, penable, paddr, pwdata, pwrite, pready, pslverr, cmd_reg, addr_reg, dummy_reg, pclk, presetn, len_reg, tx_fifo_data, tx_fifo_wr_pulse);
...
always@(posedge pclk or negedge presetn)begin
        if(!presetn) begin
                ...
                ctrl_reg <= ctrl_reg[0] ? 0 : ctrl_reg;
