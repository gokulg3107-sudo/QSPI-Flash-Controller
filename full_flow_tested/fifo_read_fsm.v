...
//Use TX fifo only for page program because it is the only command which needs to write data into flash
always@(current_state, start, fifo_read_data, cmd_reg, len_reg, count_bytes_sent)begin
