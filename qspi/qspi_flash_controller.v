...
module qspi_flash_controller(sclk, presetn, cmd_reg, addr_reg, dummy_reg, width_reg, len_reg, data_reg, start, cs, si, so, wp, sio3, dout, valid);
input sclk, presetn, start;
input [7:0] cmd_reg, width_reg, len_reg, data_reg;
input [23:0] addr_reg;
input [4:0] dummy_reg;
output cs;
output reg valid;
