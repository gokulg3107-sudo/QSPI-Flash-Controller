...
module fifo_write_fsm(pclk, presetn, write_data, wr_pulse, cmd_reg, len_reg, start, wen, fifo_data_in);
input pclk, presetn, start, wr_pulse;
input [7:0] write_data, len_reg, cmd_reg;
output reg wen;
